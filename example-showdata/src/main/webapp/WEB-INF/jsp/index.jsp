...
<!-- END SHORTCUT ICON -->
<%--<title>流量运营分析 - pinyougou®itcast全站数据平台</title>--%><title>基于hadoop网站流量日志数据分析系统</title>
<!-- BEGIN STYLESHEET-->
						...
						<section class="panel">
							<div class="panel-body">
								...
								<script type="text/javascript">
                                    ...
                                    var array = [];
                                    // 异步加载数据
                                    $.get('http://localhost:8080/refererTypeNum').done(function( data) {

                                        		for (var i = 0; i < data.types.length; i++) {
													var map ={};
													map.name = data.types[i];
													map.value = data.nums[i];
													array[i]=map;
                                        		}
                                                // 填入数据
                                                myChart.setOption({
